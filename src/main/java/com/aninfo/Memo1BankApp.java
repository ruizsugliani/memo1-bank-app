...
public class Memo1BankApp {
	...
	public ResponseEntity<List<Transaction>> getTransactionsByAccountCbu(@PathVariable Long cbu) {
		List<Transaction> transactionOptional = transactionService.findByCbu(cbu);
